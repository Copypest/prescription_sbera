...
$result = mysqli_query($link,"SELECT * FROM patient where patient_first_name='$_POST[fname]' and patient_last_name = '$_POST[lname]' and patient_cell_num = '$_POST[cellnum]'");
...
/* GET VISIT NUMBER */
$result = mysqli_query($link,"SELECT count( patient_id ) FROM visit WHERE patient_id = '$patient_id' ");
while($row = mysqli_fetch_assoc($result))
  {
...
$result = mysqli_query($link,"SELECT max( visit_id ) FROM visit");
while($row = mysqli_fetch_assoc($result))
  {
