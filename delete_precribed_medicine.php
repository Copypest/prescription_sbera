...
mysqli_query($link,"delete from precribed_medicine where MEDICINE_ID = '$MEDICINE_ID' and PRESCRIPTION_ID ='$PRESCRIPTION_ID'") or die(mysqli_error($link));

$result = mysqli_query($link,"select * from precribed_medicine where PRESCRIPTION_ID ='$PRESCRIPTION_ID'" );
